...
indigena_reg5 <- tbl(censo_conectar(), "zonas") %>% 
  mutate(
...
indigena_reg5 %>% frq (indigena)


indigena_reg5 <- indigena_reg5 %>% 
...
ggsave("img/poblacionindigena_(5)valparaiso.png", width = 29, height = 15, units = "cm")
